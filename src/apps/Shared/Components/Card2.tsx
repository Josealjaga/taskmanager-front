...
const Card2: FC<CardProps> = ({ title, children, isEditing = false }) => {
  return (
    <motion.article
      ...
      className="relative w-full max-w-2xl min-h-[600px] flex flex-col rounded-2xl bg-white shadow-2xl overflow-hidden"
    >
      ...
      <div className="relative z-10 p-8">
        ...
        <div className="text-indigo-500 rounded-xl shadow-inner p-6 mb-6">
